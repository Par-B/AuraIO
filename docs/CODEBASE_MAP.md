---
last_mapped: 2026-02-08T01:00:00Z
total_files: 96
total_tokens: 263332
---
...
| File | Purpose | Tokens |
|------|---------|--------|
| `include/auraio.h` | Public types and function declarations | 8,084 |
| `src/auraio.c` | API implementation, ring selection modes, merged flush+poll | 12,573 |
...
| `include/auraio/engine.hpp` | Engine class, callbacks, concepts, per-ring stats | 4,372 |
| `include/auraio/coro.hpp` | Task<T>, IoAwaitable, FsyncAwaitable | 3,204 |
| `include/auraio/buffer.hpp` | Buffer (RAII), BufferRef (explicit const ctor) | 2,425 |
...
| `auraio/src/lib.rs` | Public API, integration tests | 8,731 |
| `auraio/src/engine.rs` | Engine RAII wrapper, all I/O methods | 4,661 |
...
| `src/adaptive_ring.c` | Ring implementation, COOP_TASKRUN, batched CQE extraction | 6,674 |
