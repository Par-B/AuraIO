...
#ifndef AURA_OPTIONS_HPP
#define AURA_OPTIONS_HPP
 ...
 *     .ring_count(4)
 *     .ring_select(aura::RingSelect::Adaptive);
 *
...
class Options {
  public:
     ...
     */
    Options() noexcept { aura_options_init(&opts_); }
    ...
    Options &ring_select(RingSelect mode) noexcept {
        opts_.ring_select = static_cast<aura_ring_select_t>(mode);
        return *this;
    }
     ...
     * @return Reference to aura_options_t
     */
    [[nodiscard]] const aura_options_t &c_options() const noexcept { return opts_; }

  private:
    aura_options_t opts_;
};

} // namespace aura

#endif // AURA_OPTIONS_HPP
