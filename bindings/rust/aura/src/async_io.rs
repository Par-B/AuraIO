...
/// operation via `aura_cancel()`. Cancellation is best-effort: the kernel
...
impl Drop for IoFuture {
    fn drop(&mut self) {
        ...
        // is invalid per the C API contract. Do not call aura_cancel().
