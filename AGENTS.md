...
- Run build/test commands in Orb container `Caliente-dev`.
...
- Build library:
  - `orb -m Caliente-dev bash -c "cd /Users/par/Documents/src/AuraIO && make -j4"`
- Build and run C/C++ test suites:
  - `orb -m Caliente-dev bash -c "cd /Users/par/Documents/src/AuraIO/tests && make -j1 all"`
- Run Rust workspace tests (requires shared library path):
  - `orb -m Caliente-dev bash -c "cd /Users/par/Documents/src/AuraIO/bindings/rust && LD_LIBRARY_PATH=/Users/par/Documents/src/AuraIO/lib:${LD_LIBRARY_PATH} cargo test --workspace"`
